 ...
 *
 * Pola diadaptasi persis dari `bagdja-website-admin/app/lib/auth.ts` —
 * lihat memori arsitektur Bagdja untuk alasan desain lengkap.
 */
...
const CLIENT_ID = process.env.NEXT_PUBLIC_CLIENT_ID ?? 'bagdja-auction-market';
const REDIRECT_URI =
  process.env.NEXT_PUBLIC_REDIRECT_URI ?? 'http://localhost:5011/auth/callback';
